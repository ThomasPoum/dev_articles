defmodule DevArticlesWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(DevArticlesWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(DevArticlesWeb.Gettext, "errors", msg, opts)
    end
  end
